...
## A blanket "we don't do X" claim gets rewritten, not caveated
...
Here those claims live in `privacy.html` and the footer/marketing copy that
references it. Lead with what is actually done, then the narrower true claims —
never a blanket denial the new behavior no longer supports.
